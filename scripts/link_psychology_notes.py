...
CATEGORY_MAP: Dict[str, List[str]] = {
    '心理学': ['基础心理学','发展心理学','社会心理学','认知心理学','生物心理学','临床与咨询心理学','进化心理学','健康心理学','工业与组织心理学','环境心理学','跨文化心理学','神经心理学','实验心理学','教育心理学','行为主义（Behaviorism）','人本主义（Humanism）','精神分析（Psychoanalysis）','建构主义（Constructivism）'],
    ...
    '临床与咨询心理学': ['第三波疗法','情绪勒索（Emotional Blackmail）','边界感','边界感（增强版）','特定恐惧症'],
    '教育心理学': ['建构主义（Constructivism）','元认知能力','认知负荷理论与信息单元','人类学习效率与技能掌握能力的多维解析'],
    '行为主义（Behaviorism）': ['阿希从众实验','米尔格拉姆服从实验'],
    '人本主义（Humanism）': ['边界感','边界感（增强版）'],
    '精神分析（Psychoanalysis）': ['房树人','心理投射游戏','词语联想'],
    '建构主义（Constructivism）': ['教育心理学','元认知能力','激进建构主义与唯理论的对比'],
}
